...
-- AddForeignKey
ALTER TABLE `EvidenceSubmission` ADD CONSTRAINT `EvidenceSubmission_studentId_fkey` FOREIGN KEY (`studentId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `EvidenceSubmission` ADD CONSTRAINT `EvidenceSubmission_lessonId_fkey` FOREIGN KEY (`lessonId`) REFERENCES `Lesson`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
